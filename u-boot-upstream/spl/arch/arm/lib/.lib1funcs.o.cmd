cmd_spl/arch/arm/lib/lib1funcs.o := arm-none-eabi-gcc -Wp,-MD,spl/arch/arm/lib/.lib1funcs.o.d -nostdinc -isystem /usr/lib/gcc/arm-none-eabi/10.3.1/include -Iinclude    -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -D__ASSEMBLY__ -fno-PIE -g -DCONFIG_THUMB2_KERNEL -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-m -D__LINUX_ARM_ARCH__=7 -I./arch/arm/mach-stm32/include   -c -o spl/arch/arm/lib/lib1funcs.o arch/arm/lib/lib1funcs.S
