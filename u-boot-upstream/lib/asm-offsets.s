...
@ -I ./arch/arm/mach-stm32/include -imultilib thumb/v7-m/nofp
...
@ -mlibarch=armv7-m -march=armv7-m -auxbase-strip lib/asm-offsets.s -g -Os
...
.LASF14:
	.ascii	"/home/usepat/Emcraft/u-boot-upstream\000"
.LASF12:
	.ascii	"GNU C11 10.3.1 20210621 (release) -mthumb -mthumb-i"
	.ascii	"nterwork -mabi=aapcs-linux -mword-relocations -mno-"
	.ascii	"unaligned-access -mfloat-abi=soft -march=armv7-m -g"
	.ascii	" -Os -std=gnu11 -fno-builtin -ffreestanding -fshort"
	.ascii	"-wchar -fno-strict-aliasing -fno-stack-protector -f"
